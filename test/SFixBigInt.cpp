...
TEST_CASE( "signed fixed big integer shift right", "[SFBigint]" ) {
	...
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  64 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString(  "18446744073709551616", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  65 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString(  "36893488147419103232", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  66 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString(  "73786976294838206464", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  67 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString( "147573952589676412928", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  68 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString( "295147905179352825856", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  69 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString( "590295810358705651712", 10), true) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("10111111 01010010 01010101 10000000 10101010 01010101 00000001 10001010 00100101", 2), true) >>  70 == SFixBigInt<BIG_INT_BIT_TO_SIZE(72)>(UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("3529260907631713815077", 10) / UFixBigInt<BIG_INT_BIT_TO_SIZE(72)>::fromString("1180591620717411303424", 10), true) );
...
TEST_CASE( "signed fixed big integer modInverse", "[SFBigint]" ) {
	...
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 62369045776285).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 43567898765432)).toInt64() ==  38649570326437 );

	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 38649570326437).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 43567898765432)).toInt64() ==  18801147010853 );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64(-38649570326437).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64(-43567898765432)).toInt64() == -18801147010853 );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64(-38649570326437).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 43567898765432)).toInt64() ==  24766751754579 );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64( 38649570326437).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(46)>::fromInt64(-43567898765432)).toInt64() == -24766751754579 );

	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("16017867594215767234084978576693245168373889033733221066690514240642714658687", 10).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("64071470376863068936339914306772980674254926422336709160732384697932204415401", 10)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("84374476378202765996703081706816197849", 10) );

	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 84374476378202765996703081706816197849", 10).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 64071470376863068936339914306772980674254926422336709160732384697932204415401", 10)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 16017867594215767234084978576693245168373889033733221066690514240642714658687", 10) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-84374476378202765996703081706816197849", 10).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-64071470376863068936339914306772980674254926422336709160732384697932204415401", 10)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-16017867594215767234084978576693245168373889033733221066690514240642714658687", 10) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-84374476378202765996703081706816197849", 10).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 64071470376863068936339914306772980674254926422336709160732384697932204415401", 10)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 48053602782647301702254935730079735505881037388603488094041870457289489756714", 10) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(" 84374476378202765996703081706816197849", 10).modInverse(SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-64071470376863068936339914306772980674254926422336709160732384697932204415401", 10)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("-48053602782647301702254935730079735505881037388603488094041870457289489756714", 10) );
	...
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  1) == 0 ); // wolfram alpha: PowerMod[255, -1, 1] = 0
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  2) == 1 ); // wolfram alpha: PowerMod[255, -1, 2] = 1
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  3), NoMultiplicativeInverse ); // wolfram alpha: PowerMod[255, -1, 3] = error
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  4) == 3 ); // wolfram alpha: PowerMod[255, -1, 4] = 3
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  5), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  6), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  7) == 5 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  8) == 7 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(  9), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 10), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 11) == 6 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 12), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 13) == 5 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 14) == 5 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 15), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 16) == 15 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 17), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 18), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 19) == 12 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 20), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 21), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 22) == 17 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 23) == 12 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 24), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 25), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 26) == 5 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 27), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 28) == 19 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 29) == 24 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 30), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 31) == 9 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 32) == 31 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 33), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 34), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 35), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 36), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 37) == 9 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 38) == 31 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 39), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 40), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 41) == 32 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 42), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 43) == 14 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 44) == 39 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 45), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 46) == 35 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 47) == 40 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 48), NoMultiplicativeInverse );	// not relatively prime
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 49) == 5 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 50), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 51), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 52) == 31 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 53) == 37 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 54), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 55), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 56) == 47 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 57), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 58) == 53 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 59) == 28 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 60), NoMultiplicativeInverse);
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 61) == 50 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 62) == 9 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 63), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 64) == 63 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 65), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 66), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 67) == 36 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 68), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 69), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 70), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 71) == 22 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 72), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 73) == 71 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 74) == 9 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 75), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 76) == 31 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 77) == 61 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 78), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 79) == 22 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 80), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 81), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 82) == 73 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 83) == 14 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 84), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 85), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 86) == 57 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 87), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 88) == 39 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 89) == 37 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 90), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 91) == 5 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 92) == 35 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 93), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 94) == 87 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 95), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 96), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 97) == 35 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 98) == 5 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse( 99), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(100), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(101) == 61 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(102), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(103) == 82 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(104) == 31 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(105), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(106) == 37 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(107) == 47 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(108), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(109) == 56 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(110), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(111), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(112) == 47 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(113) == 39 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(114), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(115), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(116) == 111 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(117), NoMultiplicativeInverse);
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(118) == 87 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(119), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(120), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(121) == 28 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(122) == 111 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(123), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(124) == 71 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(125), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(126), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(127) == 1 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(128) == 127 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(129), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(130), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(131) == 56 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(132), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(133) == 12 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(134) == 103 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(135), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(136), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(137) == 36 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(138), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(139) == 6 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(140), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(141), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(142) == 93 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(143) == 83 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(144), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(145), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(146) == 71 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(147), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(148) == 83 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(149) == 97 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(150), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(151) == 106 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(152) == 31 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(153), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(154) == 61 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(155), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(156), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(157) == 149 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(158) == 101 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(159), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(160), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(161) == 12 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(162), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(163) == 101 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(164) == 155 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(165), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(166) == 97 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(167) == 93 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(168), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(169) == 57 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(170), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(171), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(172) == 143 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(173) == 19 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(174), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(175), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(176) == 127 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(177), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(178) == 37 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(179) == 106 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(180), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(181) == 159 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(182) == 5 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(183), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(184) == 127 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(185), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(186), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(187), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(188) == 87 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(189), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(190), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(191) == 3 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(192), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(193) == 165 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(194) == 35 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(195), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(196) == 103 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(197) == 17 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(198), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(199) == 32 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(200), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(201), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(202) == 61 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(203) == 82 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(204), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(205), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(206) == 185 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(207), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(208) == 31 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(209) == 50 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(210), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(211) == 24 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(212) == 143 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(213), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(214) == 47 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(215), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(216), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(217) == 40 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(218) == 165 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(219), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(220), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(221), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(222), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(223) == 7 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(224) == 159 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(225), NoMultiplicativeInverse  );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(226) == 39 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(227) == 73 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(228), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(229) == 185 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(230), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(231), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(232) == 111 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(233) == 53 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(234), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(235), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(236) == 87 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(237), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(238), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(239) == 15 );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(240), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(241) == 155 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(242) == 149 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(243), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(244) == 111 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(245), NoMultiplicativeInverse );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(246), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(247) == 31 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(248) == 71 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(249), NoMultiplicativeInverse );

	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(250), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(251) == 63 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(252), NoMultiplicativeInverse );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(253) == 127 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(254) == 1 );
	REQUIRE(           SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(254) == 1 );
	REQUIRE_THROWS_AS( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255).modInverse(255), NoMultiplicativeInverse );
}
...
TEST_CASE( "signed fixed big integer modPow", "[SFBigint]" ) {
	...
	REQUIRE(
			SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString(                                      "147058127173847711901598181942028410410", 10).modPow(
												  SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("212590621487307383100037676105693032843", 10),
			SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("45194772344359599619712314997219172273874874118738306499181802927551476662649", 10)
	...
	// b > m
	REQUIRE(
			SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("34546737496348564246541369697392157357343622947391601355298952857523410218281", 10).modPow(
			                                      SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("170316580215634215412390428579751188659", 10),
			SFixBigInt<BIG_INT_BIT_TO_SIZE(256)>::fromString("29007737496348564246541369697392157257353622947791601355298952855523410218281", 10)
	...
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(128) ); // PowerMod[ 1, 255, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>( 64) ); // PowerMod[ 1, 254, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(253), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>( 32) ); // PowerMod[ 1, 253, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(252), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>( 16) ); // PowerMod[ 1, 252, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(251), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  8) ); // PowerMod[ 1, 251, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(250), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  4) ); // PowerMod[ 1, 250, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(249), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2) ); // PowerMod[ 1, 249, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(248), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  1) ); // PowerMod[ 1, 248, 255]
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(247), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(128) ); // PowerMod[ 1, 247, 255]
	
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  8) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  2).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(251), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(250)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(248) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254) );
	REQUIRE( SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254).modPow(SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(254), SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(255)) == SFixBigInt<BIG_INT_BIT_TO_SIZE(8)>(  1) );
}
