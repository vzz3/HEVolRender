...
TEST_CASE( "signed fixed big integer modPow", "[SFBigint]" ) {
	...
	// 1258 bit
	REQUIRE(
			SFixBigInt<BIG_INT_BIT_TO_SIZE(_256_x2)>::fromString("DDD283D73A398FE7A86987D9E0A37063", 16).modPow( SFixBigInt<BIG_INT_BIT_TO_SIZE(_256_x2)>::fromString("DC9481390F23502D4F3C8D54BB194AA6", 16), SFixBigInt<BIG_INT_BIT_TO_SIZE(_256_x2)>::fromString("EA3D7298B90FCFAE01364041BCB288C", 16)
