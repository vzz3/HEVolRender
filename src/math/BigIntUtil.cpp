...
//BIG_INT_WORD_TYPE BigIntUtil::mulAdd(BIG_INT_WORD_TYPE* out, BIG_INT_WORD_COUNT_TYPE indexOut, const BIG_INT_WORD_TYPE* in, BIG_INT_WORD_COUNT_TYPE indexIn, const BIG_INT_WORD_COUNT_TYPE len, const BIG_INT_WORD_TYPE k) {
//	/*
