...
#define PAILLIER_MODULUS_BIT_LENGTH 	64 //256
...
#define GPU_INT_TEXTURE_FORMAT			VK_FORMAT_R8G8B8A8_UINT //VK_FORMAT_R8G8B8A8_UNORM //VK_FORMAT_R32G32B32A32_UINT	// one channel must fit the current BIG_INT_WORD_TYPE
